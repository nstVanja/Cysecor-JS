  ...
  function ya(h, m) {
    ...
    if (r(this.options.margin) && h.options.subtitles)
      for (var v = h.options.subtitles, w = 0; w < v.length; w++)
        if ((r(v[w].horizontalAlign) && "center" === this.horizontalAlign || v[w].horizontalAlign === this.horizontalAlign) && (r(v[w].verticalAlign) && "top" === this.verticalAlign || v[w].verticalAlign === this.verticalAlign) && !v[w].dockInsidePlotArea === !this.dockInsidePlotArea) {
          this.margin = 0;
          break
        }
  ...
  var ca = 20,
    ...
    ea = function(h, m, v) {
      ...
      for (M = !1; 0 < H.length;) m =
        H.shift(), "#" === m || "0" === m ? 0 < h.length && 0 !== Number(h.join("")) ? (x += h.shift(), M = !0) : "0" === m && (x += "0", M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? x += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? x += m : (m = 0 > P ? m.replace("+", "").replace("-", "") : m.replace("-", ""), x += m.replace(/[0]+/, function(a) {
          return X(P, a.length)
        }));
      v += (M ? w : "") + x;
      return r ? "-" + v : v
  ...
  x = Pa.Chart = function() {
      ...
      (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width, d = this.options.height ? this.height : 0 < this.container.clientHeight ?
        ...
        "ltr", w || (this._canvasJSContainer.style.height = "0px"), this.container.appendChild(this._canvasJSContainer), this.canvas = sa(a, d), this._preRenderCanvas = sa(a, d), this.canvas.style.position = "absolute", this.canvas.style.WebkitUserSelect = "none", this.canvas.style.MozUserSelect = "none", this.canvas.style.msUserSelect = "none", this.canvas.style.userSelect = "none", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ca(this.ctx),
          ...
          "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline = "top", Ca(this.overlaidCanvasCtx)), this._eventManager = new da(this), this.windowResizeHandler = J(window, "resize", function() {
            ...
            b._mouseEventHandler(a)
          }, this.allDOMEventHandlers), J(this.overlaidCanvas,
            "mouseup",
            function(a) {
              b._mouseEventHandler(a)
      ...
      for (l = 0; l < k.length; l++) {
        ...
        if (isFinite(p.dataInfo.minDiff))
          if (s = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
              (p.logarithmic && s < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && s < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) B.push(p), n.push({
            val1: q,
            val2: g
          }), t = !0;
          else if (!e) {
            ...
            for (var C = !1, u = 0; u < n.length; u++)
              if (r = n[u].getTime ? n[u].x.getTime() : n[u].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C)))
                if ("number" !== typeof n[u].y) 0 <
                  ...
                  if (0 < n[u].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(u, r, y, c), f.push(D), A = Q(A), w && f.push({
                    x: r,
                    y: y,
                    ctx: b,
                    type: D.type,
          ...
          if (0 < s.length) {
            ...
            for (f = 0; f < s.length; f++)
              if (s[f].getTime ? B = s[f].x.getTime() : B = s[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y) {
                ...
                (s[f].indexLabel ||
                  g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                  chartType: "bar",
                  dataPoint: s[f],
                  dataSeries: g,
                  point: {
                ...
                if (r = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))
                  if ("number" !==
                    ...
                    d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = u, m = n.x, u = n.y, b(), f.moveTo(n.x, n.y), m = d, u = c, D = n, c = g.nullDataLineDashType, f.setLineDash(R)), f.lineTo(m, u), w && l.lineTo(m, u)) : (f.beginPath(), f.moveTo(m, u), w && (l.beginPath(), l.moveTo(m, u)), D = {
                      x: m,
                      y: u
                    }), ja = d = !1) : (f.lineTo(m, u), w && l.lineTo(m,
                      u), 0 == h % 250 && b());
                    n = {
                      x: m,
                      y: u
              ...
              for (; h < s.length; h++)
                if (r = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                  ...
                  typeof s[h].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(r), u = a.axisY.convertValueToPixel(s[h].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || R === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = u, m = n.x, u = n.y, b(), f.moveTo(n.x, n.y), m = d, u = c, D = n, R = g.nullDataLineDashType, f.setLineDash(aa)), f.lineTo(m, Y), f.lineTo(m, u), w && (l.lineTo(m, Y), l.lineTo(m, u))) : (f.beginPath(), f.moveTo(m, u), w && (l.beginPath(), l.moveTo(m, u)), D = {
                    ...
                    d = !1) : (f.lineTo(m, Y), w && l.lineTo(m, Y), f.lineTo(m, u), w && l.lineTo(m, u), 0 == h % 250 && b()), n = {
                    x: m,
                    y: u
                    ...
                    x1: m,
                    y1: u
                  }, 0 !== s[h].markerSize && (0 < s[h].markerSize ||
                    0 < g.markerSize) && (Y = g.getMarkerProperties(h, m, u, f), B.push(Y), r = Q(r), w && B.push({
                    x: m,
                    y: u,
                    ctx: l,
                    type: Y.type,
              ...
              for (var Y = !0, q = 0; q < n.length; q++) {
                ...
                if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !Y)))
                  if ("number" !== typeof fa.y) A.connectNullData || (Y || z) || d(), Y = !0;
                    ...
                    h[f] = m - s;
                    z || Y ? (!z &&
                      A.connectNullData ? (b.setLineDash && (A.options.nullDataLineDashType || y === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (z = k.pop(), y = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(y), k.push(z), y = A.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(g, s), w && r.lineTo(g, s)) : (b.beginPath(), b.moveTo(g, s), w && (r.beginPath(), r.moveTo(g, s))), Y = z = !1) : (b.lineTo(g, s), w && r.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && r.moveTo(g, s), k.push({
                      x: g,
                      y: m - la
                    })));
                    u = {
                    ...
                    q < v.length - 1 && (R !== (v[q].lineColor || x) || y !==
                      (v[q].lineDashType || A.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, s), k.push({
                      x: g,
                      y: m - la
                    ...
                    0 <= A.dataPointIndexes[f] && 0 !== fa.markerSize &&
                      (0 < fa.markerSize || 0 < A.markerSize) && (la = A.getMarkerProperties(A.dataPointIndexes[f], g, s, b), l.push(la), f = Q(E), w && l.push({
                        x: g,
                        y: s,
                        ctx: r,
                        type: la.type,
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !Y)))
                if ("number" !== typeof fa.y) A.connectNullData || (Y || r) || d(), Y = !0;
                  ...
                  r || Y ? (!r && A.connectNullData ? (b.setLineDash && (A.options.nullDataLineDashType || u === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (r = k.pop(), u = k[k.length - 1], d(), b.moveTo(m.x, m.y), k.push(u), k.push(r), u = A.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(g, s), w && y.lineTo(g, s)) : (b.beginPath(), b.moveTo(g, s), w && (y.beginPath(), y.moveTo(g,
                    s))), Y = r = !1) : (b.lineTo(g, s), w && y.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && y.moveTo(g, s), k.push({
                    x: g,
                    y: z - E
                  })));
                  m = {
          ...
          if (0 < y.length)
            for (var C = 5 < s && z.bevelEnabled ? !0 : !1, l = 0; l < y.length; l++)
              if (y[l].getTime ? g = y[l].x.getTime() : g = y[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[l].y) && y[l].y.length && "number" === typeof y[l].y[0] && "number" === typeof y[l].y[1] && "number" === typeof y[l].y[2] && "number" === typeof y[l].y[3] && "number" ===
                ...
                c.restore();
                w && (e = Q(O), b.strokeStyle = e, b.lineWidth = Ba, 0 < Ba && (b.moveTo(t - F - G, k), b.lineTo(t - F - G, Math.max(h, p)), b.stroke(), b.moveTo(t - F - G, Math.min(h, p)), b.lineTo(t - F - G, n), b.stroke()), V(b, D, Math.max(k, n), A, Math.min(k, n), e, 0, null,
                  !1, !1, !1, !1), 0 < aa && (b.beginPath(), b.lineWidth = aa, b.moveTo(t + Y / 2, p - fa), b.lineTo(t - Y / 2, p - fa), b.stroke(), b.moveTo(t + Y / 2, h + fa), b.lineTo(t - Y / 2, h + fa), b.stroke()));
          ...
          if (0 < s.length) {
            ...
            for (f = 0; f < s.length; f++)
              if (s[f].getTime ? k = s[f].x.getTime() : k = s[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(s[f].y) && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1]) {
                ...
                b = Q(b);
                w && V(this._eventManager.ghostCtx, l, a.axisX.reversed ? v : h, t, a.axisX.reversed ? h : v, b, 0, null,
                  !1, !1, !1, !1);
              ...
              if (u = p[g].x.getTime ?
                ...
                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                  ...
                  q || R ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || A === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = F, A = n.nullDataLineDashType,
                    b.setLineDash(x)), b.lineTo(s, m), w && e.lineTo(s, m), h.push({
                    x: s,
                    y1: m,
                    y2: r
      ...
      function c(a) {
        ...
        for (b = 0; b < n.length; b++) {
          ...
          if (d > c) {
            ...
            } else if (0 < Math.abs(g[b].center.x - y.x) || 0 < Math.abs(g[b].center.y - y.y)) g[b].center.x = y.x + e * (1 - a), g[b].center.y = y.y + f * (1 - a),
              l = !0;
    ...
    m.prototype.renderFunnel =
      function(a) {
        ...
        function b() {
          if (u && z) {
            for (var a, b, c, d, e, f, k, l, h, n, p, q, t, m, s, B = [], y = [], v = {
                percent: null,
                total: null
        ...
        for (n = 0; n < m.length; n++) {
          ...
          if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
            if ("horizontal" === this.orientation) {
              ...
              items: [],
              width: 0
            }, k.push(p)) : (p = k[z], z = (z + 1) % k.length), this.height += q.textBlock.height;
        ...
        for (var z = [], y = [], x = [], D = [], M = [], N = [], P = [], Q = []; 4 >
          ...
          if (a && 0 < a.length)
            for (g =
              ...
              h, a[g].lineCoordinates.y2 = h + a[g].lineThickness / 2, "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + z[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ("inside" === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = {
                x1: l,
                y1: h,
                x2: m,
                y2: k - (U + e - z[g] - G),
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), m = Math.round(l), L = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + V + W < Math.max(L, p) ? Math.max(L, p) : f.y1 + V + W), L = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (U + e + L)), b[g].lineCoordinates = {
              x1: l + X,
              y1: h,
              x2: l + X,
              y2: k,
      ...
      if (0 !==
        ...
        if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
          if (b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0, h = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, m = this.chart.plotArea.y2 +
              p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, m = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = {
              x1: b - p / 2,
              y1: e,
              x2: h + p / 2,
              y2: m
            }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, m), this.ctx.lineTo(h, m), this.ctx.lineTo(h, e);
          ...
          if (e = 1 === p % 2 ? (e.y << 0) + 0.5 : e.y <<
            0, m = 1 === p % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, h = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, h = this.chart.plotArea.x1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = {
              x1: b,
              y1: e - p / 2,
              x2: h,
              y2: m + p / 2
            }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(h, e), this.ctx.lineTo(h, m), this.ctx.lineTo(b, m);
          else if ("wavy" === this.type) {
          r = b;
          k = e;
          f = 0.5;
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          if ("bottom" === this.parent._position || "top" === this.parent._position) {
            ...
            if ("rangeBar" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type) {
              ...
              k.text = this.labelFormatter ? this.labelFormatter({
                ...
                }) : r(this.options.label) ? ea(c ? c : z.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) :
                this.label
            ...
            } else m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(z.dataPoint.y) << 0, this.value = z.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({
                chart: this.chart,
                axis: this.parent.options,
                crosshair: this.options,
                value: z.dataPoint.y
          ...
          if ("rangeColumn" === this.parent.dataSeries[x].type || "rangeArea" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type || "rangeSplineArea" === this.parent.dataSeries[x].type || "candlestick" === this.parent.dataSeries[x].type || "ohlc" === this.parent.dataSeries[x].type || "boxAndWhisker" === this.parent.dataSeries[x].type) {
            ...
            k.text = this.labelFormatter ? this.labelFormatter({
              ...
              crosshair: this.options,
              value: z.dataPoint.y[b]
            }) : r(this.options.label) ? ea(c ? c : z.dataPoint.y[b], this.valueFormatString,
            ...
            0) + 0.5 : this.parent.convertValueToPixel(z.dataSeries.dataPointEOs[z.index].cumulativeSum) << 0, k.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: z.dataSeries.dataPointEOs[z.index].cumulativeSum
          }) : r(this.options.label) ? ea(c ? c : z.dataSeries.dataPointEOs[z.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = z.dataSeries.dataPointEOs[z.index].cumulativeSum) : (w = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(z.dataPoint.y) <<
            0) + 0.5 : r(a) ? d : this.parent.convertValueToPixel(z.dataPoint.y) << 0, k.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
          if ("left" ===
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) k.text = this.labelFormatter ? this.labelFormatter({
                ...
                crosshair: this.options,
                value: c ? c : this.parent.convertPixelToValue(a)
              }) : r(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label, k.x = b - k.measureText().width /
          ...
          }) : r(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(a),
